...
class SOF_The_Ball_2002_Theme {
	...
	public function initialise() {
		 ...
		 * @since 1.0.1
		 */
		do_action( 'sof/theme/the_ball_2002/loaded' );
	...
	public function register_hooks() {
		...
		// Filter the "topics" section title.
		add_filter( 'theball_topics_title', [ $this, 'topics_title_filter' ] );
	 ...
	 * @since 1.0.0
	 */
	public function topics_title_filter( $default ) {

		// Return our theme's "topics" title.
