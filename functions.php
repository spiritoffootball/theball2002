...
define( 'THEBALL2002_VERSION', '2.0.0' );
 ...
 * @since 1.0.5
 *
 * @return SOF_The_Ball_2002_Theme $theme The theme instance.
 */
function sof_the_ball_2002_theme() {

	// Maybe instantiate theme class.
	static $theme;
	if ( ! isset( $theme ) ) {
		include get_stylesheet_directory() . '/includes/class-theme.php';
		$theme = new SOF_The_Ball_2002_Theme();
	}
